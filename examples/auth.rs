use anyhow::Result;
use google_api_rust_client_not_official::auth::service_account::ServiceAccountCredentials;
...
async fn main() -> Result<()> {
    ...
    let scoped_credentials =
        credentials.with_scopes(vec!["https://www.googleapis.com/auth/cloud-translation"]);
