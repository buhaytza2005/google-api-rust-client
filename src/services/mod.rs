...
impl ServiceBase {
    ...
    async fn make_request(&mut self, request: RequestBuilder) -> Result<String> {
        ...
        if !status_code.is_success() {
            let error_response: ServiceErrorResponse =
...
impl BaseUrl {
    pub fn url(self) -> &'static str {
        match self {
            BaseUrl::Accounts => "https://mybusinessbusinessinformation.googleapis.com",
            BaseUrl::Admins => "https://mybusinessaccountmanagement.googleapis.com",
            BaseUrl::Translate => "https://translation.googleapis.com/language/translate",
            BaseUrl::Locations => "",
        }
    }
}
